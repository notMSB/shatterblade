...
func _ready():
	...
	"Poison Strike": {"target": targets.enemy, "damage": 5, "cost": 15, "status": "Poison", "value": 50, "quick": true, "weight": 1},
	...
	"Crusher Claw": {"target": targets.enemy, "damage": 10, "cost": 20, "timing": timings.before, "effect": funcref(self, "add_hits"), "args": ["moveTarget:shield", 0, 2, false], "description": "Extra hit if the target has shields", "weight": 1},
	...
	"Take Down": {"target": targets.enemy, "damage": 10, "cost": 30, "status": "Stun", "value": 100, "weight": 1},
	...
	"Constrict": {"target": targets.enemy, "damage": 3, "cost": 20, "effect": funcref(self, "give_status"), "args": ["moveUser", "Constricting", 1], "description": "Grabs target and strikes next turn if not removed", "weight": 1},
