...
func _ready():
	...
	"Take Down": {"target": targetType.enemy, "damage": 7, "resVal": 30, "status": "Stun", "value": 100, "slot": equipType.gear, "type": moveType.special},
	...
	"Constrict": {"target": targetType.enemy, "damage": 2, "resVal": 10, "effect": funcref(self, "give_status"), "args": ["moveUser", "Constricting", 1], "description": "Grabs target and strikes next turn if not removed", "slot": equipType.gear, "type": moveType.magic},
	...
	"Venoshock": {"target": targetType.enemy, "damaging": true, "resVal": 10, "description": "Inflict 5 poison on an enemy. Shield 1 for every poison that enemy has.", "slot": equipType.gear, "type": moveType.magic},
	...
	"Bonemerang": {"target": targetType.enemy, "damage": 3, "resVal": 1, "quick": true, "slot": equipType.gear, "type": moveType.trick},
	...
	"Piercing Sting": {"target": targetType.enemy, "damage": 20, "resVal": 5, "status": "Poison", "value": 10, "slot": equipType.gear, "type": moveType.trick},
	...
	"Taunt": {"target": targetType.enemy, "status": "Provoke", "value": 100, "resVal": 2, "quick": true, "slot": equipType.gear, "type": moveType.trick},
	"Eye Poke": {"target": targetType.enemy, "resVal": 2, "description": "Inflict 100 stun if enemy is targeting the user.", "slot": equipType.gear, "type": moveType.trick},
	
	"Reload": {"target": targetType.none, "resVal": 2, "cycle": true, "quick": true, "slot": equipType.none, "type": moveType.trick},
	
	
	"Double Slash": {"target": targetType.enemy, "damage": 4, "resVal": 1, "slot": equipType.gear, "type": moveType.item},
	...
	"Power Loader": {"slot": equipType.relic, "type": moveType.trick, "rarity": rarities.uncommon, "unusable": true, "discount": ["Reload", 1], "description": "Reloads cost 1 less."},
