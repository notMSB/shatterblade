...
onready var enemyList = {
	"Bat": {"stats": [4], "passives": {"Dodgy": 1}, "specials": ["Vampire"], 
		"rewards": ["wing"], "locations": [l.day], "difficulty": 1},
	"Bird": {"stats": [18], "specials": ["Dive Bomb", "Triple Hit"], 
		"rewards": ["talon"], "locations": [l.day], "difficulty": 3},
	"Flower": {"stats": [13], "passives": {"Thorns": 1}, "specials": ["Growth"], 
	...
	"Scorpion": {"stats": [26], "specials": ["Piercing Sting", "Crusher Claw"], 
		"rewards": ["blade"], "locations": [l.dungeon], "difficulty": 2},
	"Skeleton": {"stats": [33], "specials": ["Power Attack", "Coldsteel"], 
		"rewards": ["bone"], "locations": [l.night], "difficulty": 3},
	"Snake": {"stats": [14], "passives": {"Venomous": 0}, "specials": ["Constrict"], 
		"rewards": ["venom"], "locations": [l.day], "difficulty": 2},
	"Wolf": {"stats": [24], "specials": ["Take Down", "Frostfang"], 
