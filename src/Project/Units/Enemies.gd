...
onready var enemyList = {
	...
	"PRat": {"stats": [6, 7], "passives": {"Dodgy": 1}, "specials": ["Plague"], 
		"biome": b.plains, "rewards": ["fur"], "locations": [l.day], "difficulty": 2, "sprite": "Rat"},
	"PSnake": {"stats": [11, 14], "passives": {"Venomous": 0}, "specials": ["Constrict"], "hardSpecials": ["Venoshock"],
	...
	"FZombie": {"stats": [28, 38], "specials": ["Dark Spikes"], "hardSpecials": ["Mass Infection"],
	...
	"CZombie": {"stats": [28, 38], "specials": ["Dark Spikes"], "hardSpecials": ["Mass Infection"],
	...
	"GBat": {"stats": [4, 8], "passives": {"Dodgy": 1}, "specials": ["Vampire"], 
	...
	"GZombie": {"stats": [22, 31], "specials": ["Dark Spikes"], "hardSpecials": ["Mass Infection"],
